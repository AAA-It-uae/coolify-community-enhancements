# Coolify Community Pack for 4.3.18
...
This installer is intentionally pinned to **Coolify 4.3.18**.
...
It refuses unknown versions, checks the running Coolify files against the official 4.3.18 source, creates a backup, validates PHP and Blade, restarts only the Coolify app container, waits for health, and rolls back automatically if the install fails.
...
Test target: `v4.3.18`  
Official commit: `abc701ac6503afc602661fcfc52e0c455f289e73`
