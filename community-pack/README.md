# Coolify Community Pack for 4.3.19
...
This installer is intentionally pinned to **Coolify 4.3.19**.
...
It refuses unknown versions, checks the running Coolify files against the official 4.3.19 source, creates a backup, validates PHP and Blade, restarts only the Coolify app container, waits for health, and rolls back automatically if the install fails.
...
Test target: `v4.3.19`  
Official commit: `33f453912ad5298620b513269119e404c68f41dc`
